...
eftSec.checkout = {
    ...
    frameReady: false,
    settings: {
        serviceUrl: '{protocol}://eftsecure.callpay.com/eft',
        theme: 'generic',
        primaryColor: null,
        secondaryColor: null,
        token: null,
    ...
    hideFrame: function() {
        if (document.contains(document.getElementById("eftsecure_checkout_app"))) {
            document.getElementById("eftsecure_checkout_app").remove();
        }
    ...
    createFrame: function() {
        ...
        iframe.onload = function (){
            eftSec.checkout.frame = document.getElementById('eftsecure_checkout_app');
        ...
        this.frame = document.getElementById('eftsecure_checkout_app');
        return iframe;
    },
    validate: function() {
